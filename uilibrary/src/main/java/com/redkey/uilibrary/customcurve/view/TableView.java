package com.redkey.uilibrary.customcurve.view;
...
public class TableView extends View {
    ...
    private ArrayList mCoordinateXValues;// 外界传入
     ...
     */
    public void setupCoordinator(String xUnit, String yUnit, ArrayList<Integer> coordinateXValues) {
        mXUnit = xUnit;
        mYUnit = yUnit;
    ...
    private void drawCoordinate(Canvas canvas) {
        ...
        // 2. 绘制纵轴线和横坐标单位
        int yLineCount = mCoordinateXValues.size();
        ...
        for (int i = 0; i < yLineCount; i++) {
            ...
            canvas.drawLine(start.x, start.y, stop.x, stop.y, mCoordinatorPaint);
            // 绘制横坐标单位
            String drawText = String.valueOf(mCoordinateXValues.get(i));
            Paint.FontMetricsInt fontMetrics = mTextPaint.getFontMetricsInt();
            float offsetY = ((fontMetrics.bottom - fontMetrics.top) / 2 + fontMetrics.bottom) / 2;
