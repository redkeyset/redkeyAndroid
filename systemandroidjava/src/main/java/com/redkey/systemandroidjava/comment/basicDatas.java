package com.redkey.systemandroidjava.comment;
...
public class basicDatas {
    ...
    private void initData() {
        ...
        BasicList.setActivityArouter(ArouterPers.SystemAndroidLibs.batterySystem);
        BasicList.setClassName("Battery");
        BasicList.setDescription("battery电池相关");
